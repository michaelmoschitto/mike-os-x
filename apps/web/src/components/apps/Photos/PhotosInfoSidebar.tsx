...
const PhotosInfoSidebar = ({ photo, currentIndex, totalPhotos }: PhotosInfoSidebarProps) => {
  ...
  return (
    <div className="w-[250px] overflow-y-auto border-l border-[var(--color-border-subtle)] bg-[var(--color-bg-subtle)] p-4">
      <div className="font-ui mb-2 text-[11px] font-semibold text-[var(--color-text-secondary)]">
        Information
      </div>
      <div className="space-y-4">
        <div>
          <div className="font-ui mb-1 text-[10px] font-semibold text-[var(--color-text-secondary)]">
            Title
          </div>
        ...
        <div>
          ...
          <div className="font-ui text-xs break-all text-[var(--color-text-secondary)]">
            {photo.path}
          </div>
        </div>
        {totalPhotos > 1 && (
